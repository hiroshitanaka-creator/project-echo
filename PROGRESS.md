...
## ECHO-20260308-008 P2 Sprint-2 初回実装（監査運用テンプレート）

- `docs/templates/p2_audit_archive_manifest.md` を追加し、週次アーカイブの命名規約・必須証跡・検証チェックリストを固定化。
- `docs/templates/p2_kpi_delta_report.md` を追加し、前週比KPI差分（性能/メモリ/署名成功率/Invariant pass）を1ページでレビュー可能化。
- `docs/OPERATING_PROCEDURE.md` に P2 Sprint-2 の定例運用節（命名規約・テンプレート・初期化コマンド）を追記。
