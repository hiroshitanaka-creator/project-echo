...
def test_boundary_high_bias_never_auto_allows(bias_original, bias_final, merchants_final, price_buckets_final):
...
def test_boundary_ai_recommends_always_false(bias_original, bias_final, merchants_final, price_buckets_final):
...
def test_boundary_monopoly_requires_confirmation(bias_original, bias_final, merchants_final, price_buckets_final):
